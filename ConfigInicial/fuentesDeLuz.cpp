...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 9 Fernando Perez", nullptr, nullptr);
	...
	Model glass((char*)"Models/glass-plane.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// SpotLight (posición y dirección)
