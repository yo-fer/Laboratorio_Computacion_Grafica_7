...
glm::vec3 lightPos2(2.0f, 1.5, 2.5f);
...
int main()
{
    ...
    // otro modelo
    Model dino((char*)"Models/dino2.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.5f, 0.3f, 0.5f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.4f, 0.4f, 0.6f);
        ...
        // Set material properties
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.5f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.9f, 0.3f, 0.6f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 1.0f, 0.5f, 0.2f);
